...
tags:
  ...
  - 'dados blockchain'
seo:
  metaTitle: 'The Graph (GRT): Indexação Descentralizada de Dados Blockchain | A Cifra'
  metaDescription: 'Entenda como The Graph está revolucionando o acesso a dados blockchain através de indexação descentralizada.'
  keywords:
    - 'the graph'
    - 'grt'
    - 'indexação'
...
**The Graph** é um protocolo de indexação descentralizado que permite consultas eficientes de dados blockchain.
