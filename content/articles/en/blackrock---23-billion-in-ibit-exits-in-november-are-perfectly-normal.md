...
title: BlackRock - $2.3 Billion in IBIT Exits in November are Perfectly Normal
slug: blackrock---23-billion-in-ibit-exits-in-november-are-perfectly-normal
excerpt: >-
  Executive of BlackRock says $2.34 billion in outflows from IBIT Bitcoin ETF in
  November are normal after demand that took the fund close to $100 billion.
  Market impact analysis.
coverImage:
  src: >-
    /images/articles/blackrock---23-billion-in-ibit-exits-in-november-are-perfectly-normal.webp
...
tags:
  ...
  - institucional
seo:
  metaTitle: 'BlackRock IBIT: $2.3B in Outflows Are Normal? Analysis | The Number'
  metaDescription: >-
    BlackRock says $2.34 billion in November outflows from the Bitcoin IBIT ETF
    are normal. Full analysis of the impact, comparison with other ETFs and what
    to expect.
  keywords:
    - blackrock ibit
    - bitcoin etf
...
metaTitle: BlackRock - $2.3 Billion in IBIT Exits in November are Perfe
metaDescription: >-
  BlackRock's $2.3 billion IBIT exit in November is normal, given the massive
  demand that boosted the fund to nearly $100 billion in assets. Read more!
---
...
**Lógica:** Investidores que compraram IBIT em $50K-$70K estão vendendo em $90K+ (lucro de 30-80%).

### 2. Rotação para Altcoins
...
**Muitos fundos** fecham ano fiscal em novembro/dezembro.

**Ação comum:**
- Realizar lucros
- Rebalancear portfólio
- Preparar para novo ano
...
| ETF | Gestor | AUM | Fluxo Nov | Fluxo Anual |
|-----|--------|-----|-----------|-------------|
| **IBIT** | BlackRock | $52B | -$2,34B | +$50B |
| **FBTC** | Fidelity | $18B | -$800M | +$17B |
| **GBTC** | Grayscale | $12B | -$1,2B | -$8B |
| **ARKB** | ARK Invest | $4B | -$200M | +$3,8B |
| **BITB** | Bitwise | $3B | -$150M | +$2,9B |

**Observação:** Todos os ETFs tiveram saídas em novembro, não apenas IBIT.

**Total do mercado:**
- **Saídas em novembro:** $4,69B
- **Entradas em 2025:** $65B
- **Saldo líquido:** +$60,31B

**Conclusão:** Saídas de novembro são apenas 7% das entradas anuais. **Tendência continua bullish.**

## É Motivo de Preocupação?

### Argumentos de Que NÃO É Preocupante

**1. Saídas São Pequenas Relativamente**

$2,34B parece muito, mas é apenas **4,5% do AUM** do IBIT.

**Comparação:**
- **GBTC perdeu 40%** do AUM em 2024 (conversão para ETF)
- **IBIT perdeu 4,5%** em novembro

**Diferença:** GBTC teve fuga massiva. IBIT teve realização de lucros normal.

**2. Entradas Anuais Ainda São Massivas**
...
**Interpretação:** Um mês ruim não muda tendência de longo prazo.

**3. Outros Ativos Também Tiveram Saídas**
...
**4. BlackRock Não Está Preocupada**

Se a maior gestora do mundo diz que é normal, provavelmente é.

**Histórico:** [BlackRock](/artigo/blackrock---23-billion-initime-withdrawals-from-ibit-in-november-are-perfectly-normal "BlackRock - $2.3 Billion initime Withdrawals from IBIT in November are Perfectly Normal") tem 40+ anos de experiência gerenciando trilhões.

### Argumentos de Que PODE Ser Preocupante

**1. Momentum Quebrou**

**Antes:** IBIT tinha entradas consistentes de $500M-$1B/semana

**Agora:** Saídas de $500M-$800M/semana

**Risco:** Se saídas continuarem em dezembro, pode sinalizar mudança de tendência.

**2. Investidores Institucionais Vendendo**

**Dados:** 70% das saídas vieram de investidores institucionais (fundos, family offices).

**Interpretação:** "Smart money" está realizando lucros. Pode saber algo que varejo não sabe.
...
### GBTC (Grayscale) - O Veterano

**Lançado:** 2013 (convertido para ETF em jan/2025)

**Histórico:**
- **2020-2021:** Entradas massivas ($20B+)
- **2022-2023:** Preso em estrutura de trust (premium negativo)
- **2024:** Conversão para ETF, saídas de $15B
- **2025:** Estabilizou em $12B

**Taxa:** 1,5% ao ano

### IBIT (BlackRock) - O Novo Rei

**Lançado:** Janeiro 2025

**Histórico:**
- **Jan-Out:** Entradas de $52B (recorde)
- **Nov:** Saídas de $2,34B (primeira saída significativa)
- **Atual:** $52B AUM

**Taxa:** 0,25% ao ano (6x mais barato que GBTC)

### Por Que IBIT Dominou?

**1. Taxa Baixa**

0,25% vs 1,5% do GBTC = economia de $1,25M por ano para cada $100M investido.

**2. Marca BlackRock**

Maior gestora do mundo ($10 trilhões AUM). Investidores confiam.

**3. Liquidez**

IBIT tem volume diário de $1-2B. Fácil comprar/vender.

**4. Marketing**

[BlackRock](/artigo/blackrock---23-billones-en-salidas-del-ibit-en-noviembre-son-perfectamente-normales "BlackRock - $2.3 Billones en Salidas del IBIT en Noviembre Son Perfectamente Normales") promoveu agressivamente para clientes institucionais.
...
**Dados de 2025:**
- **Jan-Mar:** Entradas de $15B → BTC $42K → $65K (+54%)
- **Abr-Jun:** Entradas de $12B → BTC $65K → $72K (+10%)
- **Jul-Set:** Entradas de $18B → BTC $72K → $88K (+22%)
- **Out:** Entradas de $7B → BTC $88K → $99K (+12%)
- **Nov:** Saídas de $4,7B → BTC $99K → $92K (-7%)

**Correlação:** ~0,75 (forte)

**Interpretação:** Fluxos de ETF têm impacto significativo no preço.
