...
**2. Bridges**
- **Como funciona:** BTC atravessa ponte para outras chains
- **Problema:** Pontes são hackeadas frequentemente
...
3. **Você usa btcBTC no Aave**
   - Empresta btcBTC e ganha juros
   - Ou usa como colateral para pegar emprestado
   - Tudo sem perder custódia do BTC original

4. **Resgate quando quiser**
   - Queima btcBTC
   - Recebe BTC de volta
   - Processo automático via smart contracts

### Diferença do WBTC

| Característica | WBTC | Babylon btcBTC |
|----------------|------|----------------|
| **Custódia** | BitGo (centralizado) | Você (trustless) |
| **Risco** | Contraparte | Apenas smart contract |
| **Transparência** | Limitada | Total (on-chain) |
| **Resgate** | Depende de BitGo | Automático |
| **Regulação** | Vulnerável | Descentralizado |
...
- **Borrowers:** Usam colateral, pegam emprestado
- **Taxas:** Determinadas por oferta/demanda
...
3. Recebe 1 btcBTC
4. Deposita btcBTC no Aave
5. **Ganha 3-5% APY** em juros

**Vantagens:**
- Mantém exposição ao BTC
- Ganha renda passiva
- Custódia trustless
...
3. Usa btcBTC como colateral no Aave
4. **Pega emprestado $100K em USDC**
5. Usa USDC para o que quiser

**Vantagens:**
- Não vende BTC (sem imposto)
- Mantém exposição ao upside
- Liquidez imediata

**Caso de uso 3: Yield Farming**
...
**1. Time-Locks**
- BTC fica "travado" por período determinado
- Só pode ser movido após time-lock expirar
- Garante que não há rug pull

**2. Multi-Sig Descentralizado**
- Não há uma entidade controlando
- Rede de validadores descentralizados
- Consenso necessário para operações

**3. Provas Criptográficas**
- Zero-knowledge proofs garantem validade
- Impossível criar btcBTC sem BTC real
- Auditável on-chain
...
**Babylon:**
- ✅ Auditado por Trail of Bits
- ✅ Auditado por Quantstamp
- ✅ Bug bounty de $1M
...
**2. Liquidações**
- Risco: Se BTC cair, colateral pode ser liquidado
- Mitigação: Manter LTV (Loan-to-Value) conservador

**3. Complexidade**
- Risco: Sistema complexo = mais pontos de falha
- Mitigação: Testes extensivos, lançamento gradual

### Riscos de Mercado

**1. Adoção Lenta**
- Holders de BTC são conservadores
- Pode demorar para ganhar tração

**2. Competição**
- Outros protocolos podem copiar
- WBTC não vai desistir facilmente

**3. Regulação**
- Reguladores podem ver como security
- Pode enfrentar desafios legais

## Como Usar (Quando Lançar)

### Passo a Passo

**1. Prepare seu BTC**
- Tenha BTC em carteira compatível
- Recomendado: MetaMask + Ledger

**2. Conecte ao Babylon**
- Acesse app.babylon.finance
- Conecte carteira
- Aprove transação
...
- Acesse app.aave.com
- Deposite btcBTC
- Empreste ou use como colateral

**5. Monitore**
- Acompanhe APY
- Verifique health factor (se pegou emprestado)
- Ajuste posição conforme necessário

### Estratégias Recomendadas

**Conservadora:**
- Deposite 10-20% do seu BTC
- Apenas empreste (não pegue emprestado)
- APY: 3-5%

**Moderada:**
- Deposite 30-40% do BTC
- Use como colateral, LTV máximo 50%
- Pega emprestado stablecoins
- APY potencial: 5-10%

**Agressiva:**
- Deposite 50%+ do BTC
- LTV até 70%
- Yield farming com empréstimos
- APY potencial: 10-20%
- **Risco:** Alto (liquidação possível)
...
### 4. Preciso pagar imposto?

**Depende do país.** No Brasil, depositar em Babylon pode ser evento tributável. Consulte contador.
...
**Q1 2026** (previsão). Testnet em dezembro 2025.

### 7. Funciona com Lightning Network?
...
### 9. Qual o mínimo para depositar?

**Ainda não anunciado.** Provavelmente 0,01 BTC (~$930).
...
**Leia também:**
- [Aave: Guia Completo do Maior Protocolo de Empréstimos DeFi](/categoria/defi)
