...
seo:
  ...
  metaDescription: 'Conheça como Render Network está democratizando acesso a poder computacional GPU através de blockchain.'
  keywords:
    - 'render'
    - 'rndr'
    - 'gpu'
...
**Render Network** conecta artistas que precisam de poder de renderização com provedores de GPU ociosa.
