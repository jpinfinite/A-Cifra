...
metaTitle: 'MicroStrategy Enfrenta Remoção do Índice MSCI - Risco de $8,...'
metaDescription: >-
  MicroStrategy pode ser removida do índice MSCI, ameaçando $8,8 bilhões em
  saídas de fundos passivos. Entenda o impacto desta decisão para MSTR, Bitcoin
  e o...
...
**MSCI Inc.** (maior provedor de índices do mundo) está considerando **reclassificar empresas de "tesouraria de ativos digitais"** (Digital Asset Treasury - DAT), incluindo [MicroStrategy](/artigo/microstrategy-faces-msci-index-removal---risk-of-88-billion-in-outflows "MicroStrategy Faces MSCI Index Removal - Risk of $8.8 Billion in Outflows").

**Proposta:**
- Remover DATs de índices principais
- Criar categoria separada para essas empresas
- Implementação: Q1 2026

**Razão oficial:** DATs não se encaixam em categorias tradicionais de negócios.

### O Que São DATs?

**Digital Asset Treasury (DAT)** = Empresas que mantêm criptomoedas como ativo principal de tesouraria.

**Exemplos:**
- **MicroStrategy (MSTR):** 386.700 BTC ($36B)
- **Marathon Digital (MARA):** 34.794 BTC
- **Riot Platforms (RIOT):** 10.427 BTC
- **Hut 8 (HUT):** 9.109 BTC

**MicroStrategy é de longe a maior.**

## Por Que Isso Importa?

### Fundos Passivos e Índices

**Como funcionam fundos passivos:**

1. **Índice MSCI** lista empresas (ex: MSCI USA Index)
2. **Fundos passivos** (ETFs, fundos mútuos) compram todas as ações do índice
3. **Investidores** compram o fundo, não ações individuais

**Exemplo:**
- Vanguard Total Stock Market ETF (VTI)
- Rastreia MSCI USA Index
- Tem $1,5 trilhão em ativos
- **Inclui MSTR** porque está no índice

**Se MSTR for removida:**
- VTI e similares **precisam vender** MSTR
- Não é escolha, é regra do fundo
- **Saída forçada** de bilhões

### $8,8 Bilhões em Risco

**Cálculo:**

**MSTR market cap:** $88 bilhões
**% em fundos passivos:** ~10%
**Total em fundos passivos:** $8,8 bilhões

**Se removida:**
- Fundos vendem $8,8B em MSTR
- Pressão vendedora massiva
- Preço pode cair 20-40%

**Efeito cascata:**
- Outros índices podem seguir MSCI
- S&P 500, Russell 2000, etc.
- Saídas totais podem chegar a $15-20B

## Impacto na MicroStrategy

### Preço da Ação

**MSTR hoje:** $380
**Reação à notícia:** -8,5%

**Cenários:**

**Se removida:**
- Queda imediata: 15-25%
- Preço alvo: $285-$320
...
- 386.700 BTC
- Valor: ~$36 bilhões
- Custo médio: $56.761/BTC

**Impacto da remoção:**

**Cenário 1: Forçada a vender BTC**
- Improvável (não há obrigação legal)
- Mas pressão de acionistas pode aumentar

**Cenário 2: Pausa nas compras**
- Mais provável
- Dificuldade em levantar capital
- Crescimento da posição desacelera

**Cenário 3: Continua comprando**
- Michael Saylor é teimoso
- Pode usar dívida conversível
- Ignora pressão do mercado

**Nossa aposta:** Cenário 2 (pausa temporária)

## Por Que MSCI Quer Remover?
...
- MSTR é 2-3x mais volátil que S&P 500
- Distorce índices
...
**1. [MicroStrategy](/artigo/microstrategy-enfrenta-retirada-del-ndice-msci---riesgo-de-88-mil-millones-en-retiros "MicroStrategy Enfrenta Retirada del Índice MSCI - Riesgo de $8,8 Mil millones en Retiros") ainda tem negócio de software**
- Receita anual: $500M
...
> "[MicroStrategy](/artigo/microstrategy-enfrenta-retirada-del-ndice-msci---riesgo-de-88-mil-millones-en-salidas "MicroStrategy Enfrenta Retirada del Índice MSCI - Riesgo de $8,8 Mil millones en Salidas") é uma empresa de software enterprise com a melhor tesouraria corporativa do mundo. Não vamos mudar nossa estratégia por causa de índices."
...
1. **Lobby com MSCI**
   - Argumentar que ainda é empresa de software
   - Mostrar receita operacional
   - Pedir categoria especial
...
**Historicamente:**
- MSTR sobe 2x mais que BTC em bull market
- MSTR cai 2x mais que BTC em bear market
...
**Razão:** Não há obrigação legal de vender. Saylor não vai vender voluntariamente.
...
- Demanda institucional (ETFs) continua
- MSTR não vai vender
- Queda seria temporária
...
## Outros DATs Afetados

### Marathon Digital (MARA)

**Posição:** 34.794 BTC
**Market cap:** $8B
**Risco:** Também pode ser removida

**Impacto:**
- Menor que MSTR (empresa menor)
- Mas ainda significativo
- Ação pode cair 15-20%
...
**Posição:** 9.109 BTC
**Market cap:** $2B
**Risco:** Baixo (empresa menor)

### Impacto Total

**Se todos DATs forem removidos:**
- Saídas totais: $12-15B
- Pressão vendedora em mineradoras
- Setor de mineração pode cair 20-30%
...
**Dezembro 2025:**
- MSCI consulta pública
- Feedback de investidores
- MicroStrategy faz lobby

**Janeiro 2026:**
- MSCI anuncia decisão final
- Se aprovada, implementação em fevereiro

**Fevereiro 2026:**
- Fundos passivos vendem MSTR
- Volatilidade extrema esperada
- Possível queda de 20-30%

**Março-Junho 2026:**
- Mercado se estabiliza
- Fundos ativos compram
- Recuperação gradual

### Possíveis Desfechos

**Cenário 1: MSTR é removida (40%)**
- Saídas de $8,8B
- Ação cai 20-30%
- Recupera em 6-12 meses
...
- MSTR fica em índice separado
- Alguns fundos mantêm, outros vendem
- Impacto moderado (-5 a -10%)
...
**Opção 1: Hold**
- Se acredita em longo prazo
- Volatilidade é temporária
- Saylor não vai mudar estratégia

**Opção 2: Venda parcial**
- Realize 30-50% dos lucros
- Proteja contra queda
- Recompre se cair muito
...
**Agora ($380):** Risco alto (pode cair)
**Se cair para $320:** Bom ponto de entrada
**Se cair para $280:** Excelente oportunidade

**Estratégia:** Aguardar decisão do MSCI (janeiro)
...
### 1. MSTR vai ser removida com certeza?
...
### 5. Devo vender MSTR agora?

**Depende do seu perfil.** Se não aguenta volatilidade, considere venda parcial. Se é holder de longo prazo, pode manter.

### 6. É oportunidade de compra?

**Aguarde decisão do MSCI.** Se cair para $280-$320, pode ser boa entrada.
...
**Argumentam** que DATs não são negócios tradicionais e distorcem índices. **Críticos** dizem que é viés anti-cripto.
...
A possível remoção do MSCI é um **desafio significativo** para [MicroStrategy](/artigo/microstrategy-enfrenta-retirada-del-ndice-msci---riesgo-de-88-milardos-en-salidas "MicroStrategy Enfrenta Retirada del Índice MSCI - Riesgo de $8,8 Milardos en Salidas"), mas não muda os fundamentos:

**Riscos:**
- ❌ Saídas de $8,8B de fundos passivos
- ❌ Queda de 20-30% no preço da ação
- ❌ Dificuldade em levantar capital
...
**Disclaimer:** Este artigo é apenas informativo. MSTR é ativo de alto risco e volatilidade. Sempre faça sua própria pesquisa antes de investir.
