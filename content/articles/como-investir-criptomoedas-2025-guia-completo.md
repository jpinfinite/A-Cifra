...
- ✅ Gratuita
- ⚠️ Responsabilidade total é sua
...
- Dados de baleias (grandes investidores)

#### 4. **Twitter / X**
- Notícias em tempo real
- Siga: @acifrabr, @CoinDesk, @Cointelegraph
- Cuidado com shillers (promotores pagos)
...
- Qual seu objetivo? (aposentadoria, casa, viagem)
- Qual prazo? (1 ano, 5 anos, 10 anos)
...
**No Brasil:**
- Ganhos acima de R$ 35.000/mês: 15% de imposto
- Declaração obrigatória no IR se:
...
3. **YouTube** - Canais educativos em português

### Comunidades

1. **Reddit** - r/Bitcoin, r/CryptoCurrency
2. **Discord** - Comunidades de projetos específicos
3. **Telegram** - Grupos brasileiros de cripto
