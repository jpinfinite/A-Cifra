---
title: 'Imposto de Renda Cripto 2026: Tudo o Que Você Precisa Saber Agora'
date: '2025-12-17'
category: Regulação
excerpt: 'Não seja pego pelo Leão! Um guia completo sobre as novas regras de declaração de criptoativos no Brasil para o exercício de 2026.'
image: /images/articles/tax_crypto_brazil_concept.png
author: Antigravity
metaTitle: 'Declaração Criptomoedas IR 2026: Regras, Isenção e Como Declarar'
metaDescription: 'Guia atualizado sobre tributação de criptomoedas no Brasil para 2026. Entenda isenções, alíquotas de 15% e como preencher o GCAP.'
tags: ['imposto de renda', 'regulação', 'receita federal', 'tributação', 'brasil']
coverImage:
  src: /images/articles/tax_crypto_brazil_concept.png
  alt: 'Imposto de Renda e Bitcoin'
  width: 1200
  height: 630
---
...
1.  **Reúna o Histórico:** Tenha em mãos o extrato de todas as suas compras e vendas de 2025.
2.  **Bens e Direitos (Grupo 08):**
    *   Código **01** para Bitcoin.
    *   Código **02** para Outras Criptomoedas (Ether, Solana, etc).
    *   Código **03** para Stablecoins (USDT, USDC).
    *   Código **10** para NFTs.
3.  **Descriminação:** Seja detalhista. "1.5 BTC comprado na Exchange X..." ou "Carteira Própria (Ledger)". Informe o custo de aquisição (quanto você pagou em Reais), não a cotação atual.
4.  **Cotação de Fim de Ano:** Não atualize o valor do bem pela cotação de mercado em 31/12. Mantenha pelo custo de aquisição. O lucro só é apurado na venda.

## Ferramentas que Ajudam

Fazer isso manualmente é insano se você faz muitos trades. Recomendamos o uso de softwares como **MyProfit**, **Sencon** ou **Declare Cripto**, que importam suas notas de corretagem e APIs para gerar os relatórios prontos para o IRPF.
