      ...
      <div className="flex flex-col lg:flex-row min-h-[300px]">
        ...
        <CardContent className="flex-1 p-8 flex flex-col justify-center">
          ...
          <Link
            ...
            className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold focus-visible:ring-offset-2 rounded"
          >
            <Heading
              level={1}
        ...
        <Link
          href={`/artigo/${article.slug}`}
          className="lg:w-1/2 xl:w-2/5 relative overflow-hidden bg-gradient-to-br from-primary-900 to-primary-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold focus-visible:ring-offset-2"
