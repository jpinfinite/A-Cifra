...
export const metadata: Metadata = {
  title: "Regulamentação do Banco Central faz primeira vítima: fintech cripto fecha as portas no Brasil - Web Story",
...
export default function WebStoryPage() {
  const story = {
    ...
    link: "https://a-cifra.com.br/artigo/regulamentao-do-banco-central-faz-primeira-vtima-fintech-cripto-fecha-as-portas-"
  }
