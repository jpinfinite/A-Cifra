...
export const metadata: Metadata = {
  title: "Órgão de fiscalização pede feedback do setor cripto sobre reformas no Reino Unido - Web Story",
...
export default function WebStoryPage() {
  const story = {
    ...
    link: "https://a-cifra.com.br/artigo/rgo-de-fiscalizao-pede-feedback-do-setor-cripto-sobre-reformas-no-reino-unido"
  }
