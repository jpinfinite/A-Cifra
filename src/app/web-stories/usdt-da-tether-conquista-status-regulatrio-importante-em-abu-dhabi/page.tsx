...
export const metadata: Metadata = {
  title: "USDt da Tether conquista status regulatório importante em Abu Dhabi - Web Story",
...
export default function WebStoryPage() {
  const story = {
    ...
    link: "https://a-cifra.com.br/artigo/usdt-da-tether-conquista-status-regulatrio-importante-em-abu-dhabi"
  }
