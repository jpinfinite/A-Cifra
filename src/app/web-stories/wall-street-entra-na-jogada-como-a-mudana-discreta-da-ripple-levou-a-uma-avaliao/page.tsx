...
export const metadata: Metadata = {
  title: "Wall Street entra na jogada: como a mudança discreta da Ripple levou a uma avaliação de US$ 40 bilhões - Web Story",
...
export default function WebStoryPage() {
  const story = {
    ...
    link: "https://a-cifra.com.br/artigo/wall-street-entra-na-jogada-como-a-mudana-discreta-da-ripple-levou-a-uma-avaliao"
  }
