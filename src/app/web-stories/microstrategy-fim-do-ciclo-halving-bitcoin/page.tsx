...
export const metadata: Metadata = {
  title: "O Fim dos Ciclos de 4 Anos? MicroStrategy Compra Mais 10 Mil BTC Enquanto Titãs do Mercado Declaram a 'Morte do Halving' - Web Story",
  description: "Com a MicroStrategy de Michael Saylor acumulando mais quase $1 bilhão em Bitcoin, figuras como Changpeng Zhao e Cathie Wood sugerem que o padrão tradicional de ciclos de halving acabou. Estamos entran...",
}
...
export default function WebStoryPage() {
  const story = {
    ...
    posterPortrait: "https://a-cifra.com.br/images/articles/bitcoin-end-of-halving-cycle.png",
    link: "https://a-cifra.com.br/artigo/microstrategy-fim-do-ciclo-halving-bitcoin"
  }
