...
export const metadata: Metadata = {
  title: "Por que a Grayscale acredita que o Bitcoin vai romper o ciclo de quatro anos desta vez - Web Story",
...
export default function WebStoryPage() {
  const story = {
    ...
    link: "https://a-cifra.com.br/artigo/por-que-a-grayscale-acredita-que-o-bitcoin-vai-romper-o-ciclo-de-quatro-anos-des"
  }
