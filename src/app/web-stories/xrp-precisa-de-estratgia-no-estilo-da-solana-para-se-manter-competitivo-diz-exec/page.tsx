...
export const metadata: Metadata = {
  title: "XRP precisa de estratégia no estilo da Solana para se manter competitivo, diz executivo da Ripple - Web Story",
...
export default function WebStoryPage() {
  const story = {
    ...
    link: "https://a-cifra.com.br/artigo/xrp-precisa-de-estratgia-no-estilo-da-solana-para-se-manter-competitivo-diz-exec"
  }
