...
export const metadata: Metadata = {
  title: "Liqi lança carteira para tokens RWA com rendimento em dólar e liquidação em stablecoins - Web Story",
...
export default function WebStoryPage() {
  const story = {
    ...
    link: "https://a-cifra.com.br/artigo/liqi-lana-carteira-para-tokens-rwa-com-rendimento-em-dlar-e-liquidao-em-stableco"
  }
