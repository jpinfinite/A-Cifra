...
export const metadata: Metadata = {
  title: "BlackRock Revoluciona Wall Street com Pedido de ETF de Ethereum com Staking: Uma Nova Era para Investidores Institucionais - Web Story",
  description: "A gigante de gestão de ativos BlackRock protocolou um pedido histórico para o iShares Staked Ethereum Trust (ETHB), visando oferecer exposição ao ETH com recompensas de staking. Entenda como isso pode...",
}
...
export default function WebStoryPage() {
  const story = {
    ...
    posterPortrait: "https://a-cifra.com.br/images/articles/blackrock-ethereum-staking-etf.png",
    link: "https://a-cifra.com.br/artigo/blackrock-revoluciona-wall-street-com-etf-ethereum-staking"
  }
