...
export const metadata: Metadata = {
  title: "400 mil Bitcoins saíram das corretoras desde o ano passado, aponta Santiment - Web Story",
...
export default function WebStoryPage() {
  const story = {
    ...
    link: "https://a-cifra.com.br/artigo/400-mil-bitcoins-saram-das-corretoras-desde-o-ano-passado-aponta-santiment"
  }
